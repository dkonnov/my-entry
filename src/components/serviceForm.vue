              ...
              <div class="card-body">
                <form>
                  ...
                  <div class="form-group">
                    ...
                    >Опишите подробности оказываемой услуги</small>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <small
                      id="emailHelp"
                      class="form-text text-muted"
                    >Данное поле необходимо для записи через интерент на ваши услуги. Если оно заполнено, то функция записи через интернет включена. Так же необходимо заполнить ваш режим работы.</small>
                  </div>
                </form>
                <br />
                <center>
    ...
    eventEmitter.$on("showServiceForm", value => {
      if (value) {
        ...
        http
          ...
          .then(response => {
            document.getElementById("timeServiseForm").value =
              response.data.time;
