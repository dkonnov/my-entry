  ...
  methods: {
    hideDay(value) {
      if (document.getElementById("id_togle_" + value).checked == false) {
        document.getElementById("id_timepicker1_" + value).style.visibility =
          "hidden";
        document.getElementById("id_timepicker2_" + value).style.visibility =
          "hidden";
        document.getElementById("id_timepicker3_" + value).style.visibility =
          "hidden";
        document.getElementById("id_timepicker4_" + value).style.visibility =
          "hidden";
      } else {
        document.getElementById("id_timepicker1_" + value).style.visibility =
          "visible";
