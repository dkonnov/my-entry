    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <div v-show="sendPassword" @click="sendPasswordF()">
            <button
              type="button"
          ...
          <div v-show="toRegistration" @click="showRegistrationForm">
            <button type="button" class="btn btn-primary btn-sm" data-dismiss="modal">Регистрация</button>
          </div>
