     ...
     <div class="col-lg-8 col-md-6 ml-auto mr-auto">  
      <div class="card card-signup" style="padding-left: 15px;padding-right: 15px;padding-top: 15px;padding-bottom: 15px;">
          ...
          <p class="card-description">
            <center>
              Для отслеживания статистики и повышения конверсии от ваших рекламных компаний, используйте интеграцию. Вставьте номера счетчиков, которые вы используете.
            </center>
          </p> 
          ...
          <div class="input-group" :class="{'has-danger': $v.pixel.$error}">
            ...
            <input v-model="pixel" type="number" @input="$v.pixel.$touch" class="form-control" placeholder="Facebook Pixel ...">
            </div>
