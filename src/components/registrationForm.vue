          ...
          <div class="card card-login">
              ...
              <div class="col-md-6">
                ...
                <div class="card-body">
                  ...
                  <input v-model="name" @input="nameCheck" type="text" class="form-control" placeholder="Адрес (my-entry.ru\имя)">
                  <button v-show="nameOk" class="form-control-feedback">
                    <i class="material-icons">done</i>
                  </button>  
                  <button v-show="!nameOk" class="form-control-feedback" data-toggle="tooltip" data-placement="right" title="Имя страницы должно быть уникальным, начинаться с латинской буквы и может содержать только латинские буквы и цифры.">
                   ...
                   <div class="input-group form-group label-floating has-success">
                    ...
                    <input v-model="email" @input="emailCheck" type="email" class="form-control" placeholder="Электронная почта ...">
                    <button v-show="emailOk" class="form-control-feedback">
                      <i class="material-icons">done</i>
                    </button>  
                    <button v-show="!emailOk" class="form-control-feedback" data-toggle="tooltip" data-placement="right" title="Необходимо ввести адрес электронной почты, которого нет в системе. Возможны вы ранее уже регистрировались, попробуйте войти или восстановить пароль.">
                      <i class="material-icons">clear</i>
                    </button>
                  </div> 
  ...
  methods: {
    ...
    emailCheck() {
      if (checkEmail(this.email)){
        ...
        .then(response => {
          if (response.data == true) {this.emailOk = false;}
